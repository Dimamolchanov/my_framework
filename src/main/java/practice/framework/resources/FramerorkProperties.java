...
// статик реализация - насколько это хорошо? может лучше создавать объект и
// инициализировать
public class FramerorkProperties {
	...
	// насколько целесообразно инициализировать все проперти? - можно ли простов
	// ызывать их по мере надобности из класса PropertiesLoader?
