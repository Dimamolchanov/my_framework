...
public class WebDriverHandler implements SeleniumUtilsI{
	...
	if (isAlertPresent()) {
	   ...
	   // Logger.warn("[ALERT!] Alert with text '" + alert + "' is present -> ERROR!");
	...
	try {
	    ...
	    //Logger.screenshot("Screenshot <a href=" + fileName + ">" + fileName + "</a>");
	} catch (IOException e) {
    ...
    public String captureScreenShot() {
		...
		Format formatter;
		formatter = new SimpleDateFormat("yyyy_MM_dd_HH_mm_ss");//replace with constant
